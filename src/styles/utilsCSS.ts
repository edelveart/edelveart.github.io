export const NAV_LINKS_PAGES = {
  ...
  prevNext: "text-sm uppercase traking-wide  text-base-content/60",
  pageTitle:
...
export const META_BADGE_TAGS = {
  badge: "text-sm text-info/70 tracking-wider uppercase font-medium",
  tags: "text-sm text-info/70 hover:text-info/100 transition-colors underline-offset-2",
};
